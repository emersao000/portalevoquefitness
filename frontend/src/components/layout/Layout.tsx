            ...
            {user && (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="secondary"
                    className="rounded-full px-3 py-1.5 h-auto text-sm font-medium"
                  >
                    Portais <ChevronDown className="size-3.5 ml-1" />
                  </Button>
                </DropdownMenuTrigger>
            ...
            {user ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="secondary"
                    className="ml-1 hidden md:flex items-center gap-1.5 rounded-full px-3 py-1.5 h-auto text-sm font-medium"
                  >
                    <div className="h-5 w-5 rounded-full bg-primary/90 flex-shrink-0" />
