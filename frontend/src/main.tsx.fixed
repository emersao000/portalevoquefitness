...
import MeusChamadosPage from "./pages/sectors/ti/admin/chamados/MeusChamados";
...
import {
  ...
  Acoes as ConfAcoes,
  Sla as ConfSla,
  BiDashboards as ConfBiDashboards,
          ...
          <Routes>
            ...
            >
              ...
              <Route path="configuracoes" element={<ConfiguracoesLayout />}>
                ...
                <Route path="bi-dashboards" element={<ConfBiDashboards />} />
              </Route>
            </Route>
            <Route
